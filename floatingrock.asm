...
if !sa1 == 0
    ...
    ASL A                               ;  | round up if
                                        ; ; CMP $4204   original was this, but this is open bus
    CMP !TMP2                           ;  | remainder >=
    BCC CHKNEG                          ;  | 1/2 dividend
    INC !TMP1                           ; /
CHKNEG:
    CPY #$00                            ; \ if Y=0 (not negative)
    ...
    STA !TMP1                           ; /  from zero
ADDYINT:
    LDA !TMP1                           ; \  since X1 is considered
...
ENDINC:
    ...
    INC $95                             ; /  of slope
ENDINC2:
    BRA ENDROT                          ; and skip CCW rotation
DECROT:
    LDA !OFFSET,x                       ; \ when it's CCW, don't go
...
NOYOSHI2:
    ...
    BNE INWATER                         ; / or not?
INAIR:
    INC !AA,x                           ; increase Y speed for gravity
